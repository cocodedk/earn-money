# Probe Live Tab — Consolidated Spec (FINAL · implementation-ready)

Snapshot taken: 2026-05-16T14:32:32+02:00
Source folder: `docs/superpowers/specs/2026-05-16-probe-live-tab/`
Companion file: `2026-05-16-probe-live-tab.consolidated.md` (rolling, regenerated on each edit)

This snapshot is frozen at the state the second reviewer signed off as "fully closed."
All 14 spec files concatenated in reading order; original files unchanged.
