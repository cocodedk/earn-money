# 5.7 Shell command execution through parameters

> Phase 5 — Input validation and injection · Category: Command injection

**Status:** pending — full spec is written when phase 5 begins.
