# 15.9 Tokens stored unsafely

> Phase 15 — Client-side security · Category: Local storage/session storage

**Status:** pending — full spec is written when phase 15 begins.
