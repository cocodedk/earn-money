...
- [ ] Em-backend contract **confirmed** 2026-05-20 — SSE route `/sse/scan-runs/<uuid>/events/`, standard 3-line SSE envelope, polling REST `/api/scan-runs/<uuid>/events/`, `Last-Event-ID` honored. URLs locked in `00-overview.md` §Backend lock; Phase 3 unblocked.
