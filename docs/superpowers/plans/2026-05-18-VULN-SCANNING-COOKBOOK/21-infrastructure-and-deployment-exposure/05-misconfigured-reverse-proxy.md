...
phase: 21
spec: 5
slug: misconfigured-reverse-proxy
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/21-infrastructure-and-deployment-exposure/05-misconfigured-reverse-proxy.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 21.5 Misconfigured reverse proxy

> Spec: [`21-infrastructure-and-deployment-exposure/05-misconfigured-reverse-proxy.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/21-infrastructure-and-deployment-exposure/05-misconfigured-reverse-proxy.md)
