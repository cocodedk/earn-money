...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/21-infrastructure-and-deployment-exposure/01-exposed-admin-panels.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 21.1 Exposed admin panels

> Spec: [`21-infrastructure-and-deployment-exposure/01-exposed-admin-panels.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/21-infrastructure-and-deployment-exposure/01-exposed-admin-panels.md)
