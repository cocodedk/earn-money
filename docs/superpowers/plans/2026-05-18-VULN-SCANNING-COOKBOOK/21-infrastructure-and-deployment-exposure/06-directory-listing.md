...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/21-infrastructure-and-deployment-exposure/06-directory-listing.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 21.6 Directory listing

> Spec: [`21-infrastructure-and-deployment-exposure/06-directory-listing.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/21-infrastructure-and-deployment-exposure/06-directory-listing.md)
