...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/12-token-accepted-after-logout.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.12 Token accepted after logout

> Spec: [`03-session-management/12-token-accepted-after-logout.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/12-token-accepted-after-logout.md)
