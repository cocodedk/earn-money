...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/08-long-lived-sessions.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.8 Long-lived sessions

> Spec: [`03-session-management/08-long-lived-sessions.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/08-long-lived-sessions.md)
