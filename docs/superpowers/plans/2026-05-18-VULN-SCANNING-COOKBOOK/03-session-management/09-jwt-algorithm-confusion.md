...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/09-jwt-algorithm-confusion.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.9 JWT algorithm confusion

> Spec: [`03-session-management/09-jwt-algorithm-confusion.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/09-jwt-algorithm-confusion.md)
