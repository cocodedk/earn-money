...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/01-missing-httponly.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.1 Missing `HttpOnly`

> Spec: [`03-session-management/01-missing-httponly.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/01-missing-httponly.md)
