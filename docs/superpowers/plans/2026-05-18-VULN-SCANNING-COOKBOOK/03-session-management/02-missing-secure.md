...
spec: 2
slug: missing-secure
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/02-missing-secure.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.2 Missing `Secure`

> Spec: [`03-session-management/02-missing-secure.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/02-missing-secure.md)
