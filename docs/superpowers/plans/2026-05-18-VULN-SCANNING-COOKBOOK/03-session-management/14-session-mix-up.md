...
spec: 14
slug: session-mix-up
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/14-session-mix-up.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.14 Session mix-up

> Spec: [`03-session-management/14-session-mix-up.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/14-session-mix-up.md)
