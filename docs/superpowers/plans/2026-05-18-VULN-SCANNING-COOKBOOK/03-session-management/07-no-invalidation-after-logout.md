...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/07-no-invalidation-after-logout.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.7 No invalidation after logout

> Spec: [`03-session-management/07-no-invalidation-after-logout.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/07-no-invalidation-after-logout.md)
