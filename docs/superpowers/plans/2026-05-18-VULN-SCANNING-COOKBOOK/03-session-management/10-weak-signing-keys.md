...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/10-weak-signing-keys.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.10 Weak signing keys

> Spec: [`03-session-management/10-weak-signing-keys.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/10-weak-signing-keys.md)
