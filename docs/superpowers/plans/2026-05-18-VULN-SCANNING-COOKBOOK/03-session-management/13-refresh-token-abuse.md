...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/13-refresh-token-abuse.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.13 Refresh token abuse

> Spec: [`03-session-management/13-refresh-token-abuse.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/13-refresh-token-abuse.md)
