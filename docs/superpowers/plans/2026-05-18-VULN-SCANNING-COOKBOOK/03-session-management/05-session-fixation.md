...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/05-session-fixation.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.5 Session fixation

> Spec: [`03-session-management/05-session-fixation.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/05-session-fixation.md)
