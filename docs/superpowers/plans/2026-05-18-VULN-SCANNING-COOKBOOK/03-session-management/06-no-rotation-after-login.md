...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/06-no-rotation-after-login.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.6 No rotation after login

> Spec: [`03-session-management/06-no-rotation-after-login.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/06-no-rotation-after-login.md)
