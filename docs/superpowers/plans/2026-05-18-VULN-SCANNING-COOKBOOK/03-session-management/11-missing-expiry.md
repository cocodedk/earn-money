...
spec: 11
slug: missing-expiry
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/11-missing-expiry.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.11 Missing expiry

> Spec: [`03-session-management/11-missing-expiry.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/11-missing-expiry.md)
