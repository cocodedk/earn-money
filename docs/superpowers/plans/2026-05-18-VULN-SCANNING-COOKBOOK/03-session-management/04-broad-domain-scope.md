...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/04-broad-domain-scope.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 3.4 Broad domain scope

> Spec: [`03-session-management/04-broad-domain-scope.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/03-session-management/04-broad-domain-scope.md)
