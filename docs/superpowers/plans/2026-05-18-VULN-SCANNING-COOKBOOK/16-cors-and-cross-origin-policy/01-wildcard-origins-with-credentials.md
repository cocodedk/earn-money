...
phase: 16
spec: 1
slug: wildcard-origins-with-credentials
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/16-cors-and-cross-origin-policy/01-wildcard-origins-with-credentials.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 16.1 Wildcard origins with credentials

> Spec: [`16-cors-and-cross-origin-policy/01-wildcard-origins-with-credentials.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/16-cors-and-cross-origin-policy/01-wildcard-origins-with-credentials.md)
