...
phase: 16
spec: 4
slug: over-trusted-subdomains
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/16-cors-and-cross-origin-policy/04-over-trusted-subdomains.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 16.4 Over-trusted subdomains

> Spec: [`16-cors-and-cross-origin-policy/04-over-trusted-subdomains.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/16-cors-and-cross-origin-policy/04-over-trusted-subdomains.md)
