...
phase: 5
spec: 11
slug: directory-query-injection
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/11-directory-query-injection.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 5.11 Directory query injection

> Spec: [`05-input-validation-and-injection/11-directory-query-injection.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/11-directory-query-injection.md)
