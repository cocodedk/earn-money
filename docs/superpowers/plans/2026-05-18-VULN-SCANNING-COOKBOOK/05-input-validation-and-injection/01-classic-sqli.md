...
spec: 1
slug: classic-sqli
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/01-classic-sqli.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 5.1 Classic SQLi

> Spec: [`05-input-validation-and-injection/01-classic-sqli.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/01-classic-sqli.md)
