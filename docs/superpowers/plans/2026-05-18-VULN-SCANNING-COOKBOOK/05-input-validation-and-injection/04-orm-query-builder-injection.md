...
phase: 5
spec: 4
slug: orm-query-builder-injection
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/04-orm-query-builder-injection.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 5.4 ORM/query-builder injection

> Spec: [`05-input-validation-and-injection/04-orm-query-builder-injection.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/04-orm-query-builder-injection.md)
