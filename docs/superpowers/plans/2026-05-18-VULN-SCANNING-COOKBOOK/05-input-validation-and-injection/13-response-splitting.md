...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/13-response-splitting.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 5.13 Response splitting

> Spec: [`05-input-validation-and-injection/13-response-splitting.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/13-response-splitting.md)
