...
phase: 5
spec: 8
slug: unsafe-system-calls
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/08-unsafe-system-calls.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 5.8 Unsafe system calls

> Spec: [`05-input-validation-and-injection/08-unsafe-system-calls.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/08-unsafe-system-calls.md)
