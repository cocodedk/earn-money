...
phase: 5
spec: 16
slug: notification-template-abuse
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/16-notification-template-abuse.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 5.16 Notification template abuse

> Spec: [`05-input-validation-and-injection/16-notification-template-abuse.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/16-notification-template-abuse.md)
