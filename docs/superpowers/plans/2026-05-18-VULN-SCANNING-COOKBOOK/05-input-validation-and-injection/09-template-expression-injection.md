...
phase: 5
spec: 9
slug: template-expression-injection
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/09-template-expression-injection.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 5.9 Template expression injection

> Spec: [`05-input-validation-and-injection/09-template-expression-injection.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/05-input-validation-and-injection/09-template-expression-injection.md)
