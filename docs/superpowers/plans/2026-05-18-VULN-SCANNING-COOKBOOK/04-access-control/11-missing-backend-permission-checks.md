...
phase: 4
spec: 11
slug: missing-backend-permission-checks
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/11-missing-backend-permission-checks.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 4.11 Missing backend permission checks

> Spec: [`04-access-control/11-missing-backend-permission-checks.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/11-missing-backend-permission-checks.md)
