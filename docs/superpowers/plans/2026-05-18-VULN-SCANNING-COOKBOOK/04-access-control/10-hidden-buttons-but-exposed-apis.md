...
phase: 4
spec: 10
slug: hidden-buttons-but-exposed-apis
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/10-hidden-buttons-but-exposed-apis.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 4.10 Hidden buttons but exposed APIs

> Spec: [`04-access-control/10-hidden-buttons-but-exposed-apis.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/10-hidden-buttons-but-exposed-apis.md)
