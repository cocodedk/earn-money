...
phase: 4
spec: 5
slug: hidden-admin-apis
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/05-hidden-admin-apis.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 4.5 Hidden admin APIs

> Spec: [`04-access-control/05-hidden-admin-apis.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/05-hidden-admin-apis.md)
