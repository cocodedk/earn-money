...
phase: 4
spec: 15
slug: signed-url-misuse
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/15-signed-url-misuse.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 4.15 Signed URL misuse

> Spec: [`04-access-control/15-signed-url-misuse.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/04-access-control/15-signed-url-misuse.md)
