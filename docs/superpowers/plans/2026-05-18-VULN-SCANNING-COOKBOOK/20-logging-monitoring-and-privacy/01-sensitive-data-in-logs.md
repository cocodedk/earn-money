...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/20-logging-monitoring-and-privacy/01-sensitive-data-in-logs.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 20.1 Sensitive data in logs

> Spec: [`20-logging-monitoring-and-privacy/01-sensitive-data-in-logs.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/20-logging-monitoring-and-privacy/01-sensitive-data-in-logs.md)
