...
phase: 24
spec: 5
slug: retrieval-poisoning
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/05-retrieval-poisoning.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 24.5 Retrieval poisoning

> Spec: [`24-ai-llm-specific-webapp-vectors/05-retrieval-poisoning.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/05-retrieval-poisoning.md)
