...
phase: 24
spec: 4
slug: data-exfiltration-through-model-output
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/04-data-exfiltration-through-model-output.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 24.4 Data exfiltration through model output

> Spec: [`24-ai-llm-specific-webapp-vectors/04-data-exfiltration-through-model-output.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/04-data-exfiltration-through-model-output.md)
