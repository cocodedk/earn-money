...
phase: 24
spec: 7
slug: unsafe-agent-actions
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/07-unsafe-agent-actions.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 24.7 Unsafe agent actions

> Spec: [`24-ai-llm-specific-webapp-vectors/07-unsafe-agent-actions.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/07-unsafe-agent-actions.md)
