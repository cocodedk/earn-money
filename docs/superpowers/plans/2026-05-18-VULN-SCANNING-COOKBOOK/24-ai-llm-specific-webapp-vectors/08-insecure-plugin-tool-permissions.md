...
phase: 24
spec: 8
slug: insecure-plugin-tool-permissions
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/08-insecure-plugin-tool-permissions.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 24.8 Insecure plugin/tool permissions

> Spec: [`24-ai-llm-specific-webapp-vectors/08-insecure-plugin-tool-permissions.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/24-ai-llm-specific-webapp-vectors/08-insecure-plugin-tool-permissions.md)
