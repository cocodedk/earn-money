...
spec: 18
slug: login-csrf
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/18-login-csrf.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 2.18 Login CSRF

> Spec: [`02-authentication/18-login-csrf.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/18-login-csrf.md)
