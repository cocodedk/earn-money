...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/15-state-parameter-missing.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 2.15 State parameter missing

> Spec: [`02-authentication/15-state-parameter-missing.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/15-state-parameter-missing.md)
