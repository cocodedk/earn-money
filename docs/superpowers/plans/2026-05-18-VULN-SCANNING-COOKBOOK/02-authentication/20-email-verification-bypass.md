...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/20-email-verification-bypass.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 2.20 Email verification bypass

> Spec: [`02-authentication/20-email-verification-bypass.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/20-email-verification-bypass.md)
