...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/05-predictable-reset-tokens.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 2.5 Predictable reset tokens

> Spec: [`02-authentication/05-predictable-reset-tokens.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/05-predictable-reset-tokens.md)
