...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/16-token-substitution.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 2.16 Token substitution

> Spec: [`02-authentication/16-token-substitution.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/02-authentication/16-token-substitution.md)
