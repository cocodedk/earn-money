...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/01-http-request-smuggling.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 17.1 HTTP request smuggling

> Spec: [`17-http-request-response-handling/01-http-request-smuggling.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/01-http-request-smuggling.md)
