...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/02-http-response-splitting.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 17.2 HTTP response splitting

> Spec: [`17-http-request-response-handling/02-http-response-splitting.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/02-http-response-splitting.md)
