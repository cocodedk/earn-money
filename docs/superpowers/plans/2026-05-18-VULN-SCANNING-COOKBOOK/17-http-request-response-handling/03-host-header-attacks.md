...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/03-host-header-attacks.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 17.3 Host header attacks

> Spec: [`17-http-request-response-handling/03-host-header-attacks.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/03-host-header-attacks.md)
