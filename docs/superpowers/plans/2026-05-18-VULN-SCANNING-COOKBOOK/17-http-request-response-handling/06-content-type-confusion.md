...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/06-content-type-confusion.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 17.6 Content-type confusion

> Spec: [`17-http-request-response-handling/06-content-type-confusion.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/17-http-request-response-handling/06-content-type-confusion.md)
