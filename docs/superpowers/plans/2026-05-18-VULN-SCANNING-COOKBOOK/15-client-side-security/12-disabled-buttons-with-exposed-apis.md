...
phase: 15
spec: 12
slug: disabled-buttons-with-exposed-apis
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/12-disabled-buttons-with-exposed-apis.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 15.12 Disabled buttons with exposed APIs

> Spec: [`15-client-side-security/12-disabled-buttons-with-exposed-apis.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/12-disabled-buttons-with-exposed-apis.md)
