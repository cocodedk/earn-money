...
phase: 15
spec: 5
slug: source-code-leakage
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/05-source-code-leakage.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 15.5 Source code leakage

> Spec: [`15-client-side-security/05-source-code-leakage.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/05-source-code-leakage.md)
