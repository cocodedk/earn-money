...
spec: 1
slug: api-keys
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/01-api-keys.md
...
> Spec: [`15-client-side-security/01-api-keys.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/01-api-keys.md)
