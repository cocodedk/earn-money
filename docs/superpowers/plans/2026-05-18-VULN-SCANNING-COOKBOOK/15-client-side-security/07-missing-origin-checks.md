...
phase: 15
spec: 7
slug: missing-origin-checks
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/07-missing-origin-checks.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 15.7 Missing origin checks

> Spec: [`15-client-side-security/07-missing-origin-checks.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/07-missing-origin-checks.md)
