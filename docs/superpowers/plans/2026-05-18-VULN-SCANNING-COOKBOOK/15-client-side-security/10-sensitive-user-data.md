...
phase: 15
spec: 10
slug: sensitive-user-data
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/10-sensitive-user-data.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 15.10 Sensitive user data

> Spec: [`15-client-side-security/10-sensitive-user-data.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/15-client-side-security/10-sensitive-user-data.md)
