...
phase: 7
spec: 7
slug: cors-assisted-csrf-style-abuse
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/07-csrf-and-browser-side-request-abuse/07-cors-assisted-csrf-style-abuse.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 7.7 CORS-assisted CSRF-style abuse

> Spec: [`07-csrf-and-browser-side-request-abuse/07-cors-assisted-csrf-style-abuse.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/07-csrf-and-browser-side-request-abuse/07-cors-assisted-csrf-style-abuse.md)
