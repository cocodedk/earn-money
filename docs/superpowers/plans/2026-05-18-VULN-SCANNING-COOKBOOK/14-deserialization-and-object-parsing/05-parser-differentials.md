...
phase: 14
spec: 5
slug: parser-differentials
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/14-deserialization-and-object-parsing/05-parser-differentials.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 14.5 Parser differentials

> Spec: [`14-deserialization-and-object-parsing/05-parser-differentials.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/14-deserialization-and-object-parsing/05-parser-differentials.md)
