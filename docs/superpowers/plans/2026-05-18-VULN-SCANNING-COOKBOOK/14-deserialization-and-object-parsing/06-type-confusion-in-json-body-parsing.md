...
phase: 14
spec: 6
slug: type-confusion-in-json-body-parsing
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/14-deserialization-and-object-parsing/06-type-confusion-in-json-body-parsing.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 14.6 Type confusion in JSON/body parsing

> Spec: [`14-deserialization-and-object-parsing/06-type-confusion-in-json-body-parsing.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/14-deserialization-and-object-parsing/06-type-confusion-in-json-body-parsing.md)
