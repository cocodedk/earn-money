...
phase: 6
spec: 2
slug: path-reflection
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/02-path-reflection.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 6.2 Path reflection

> Spec: [`06-cross-site-scripting/02-path-reflection.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/02-path-reflection.md)
