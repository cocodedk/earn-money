...
phase: 6
spec: 1
slug: query-parameter-reflection
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/01-query-parameter-reflection.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 6.1 Query parameter reflection

> Spec: [`06-cross-site-scripting/01-query-parameter-reflection.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/01-query-parameter-reflection.md)
