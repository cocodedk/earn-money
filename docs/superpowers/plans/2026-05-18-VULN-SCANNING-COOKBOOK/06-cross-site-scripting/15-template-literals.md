...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/15-template-literals.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 6.15 Template literals

> Spec: [`06-cross-site-scripting/15-template-literals.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/15-template-literals.md)
