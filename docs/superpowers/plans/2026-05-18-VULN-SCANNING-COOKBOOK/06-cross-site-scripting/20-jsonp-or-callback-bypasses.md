...
phase: 6
spec: 20
slug: jsonp-or-callback-bypasses
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/20-jsonp-or-callback-bypasses.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 6.20 JSONP or callback bypasses

> Spec: [`06-cross-site-scripting/20-jsonp-or-callback-bypasses.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/06-cross-site-scripting/20-jsonp-or-callback-bypasses.md)
