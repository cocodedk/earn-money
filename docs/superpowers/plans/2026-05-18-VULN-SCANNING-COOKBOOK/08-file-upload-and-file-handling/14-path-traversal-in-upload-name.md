...
phase: 8
spec: 14
slug: path-traversal-in-upload-name
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/08-file-upload-and-file-handling/14-path-traversal-in-upload-name.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 8.14 Path traversal in upload name

> Spec: [`08-file-upload-and-file-handling/14-path-traversal-in-upload-name.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/08-file-upload-and-file-handling/14-path-traversal-in-upload-name.md)
