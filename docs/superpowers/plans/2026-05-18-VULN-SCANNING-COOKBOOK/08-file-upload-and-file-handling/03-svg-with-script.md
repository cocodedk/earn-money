...
phase: 8
spec: 3
slug: svg-with-script
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/08-file-upload-and-file-handling/03-svg-with-script.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 8.3 SVG with script

> Spec: [`08-file-upload-and-file-handling/03-svg-with-script.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/08-file-upload-and-file-handling/03-svg-with-script.md)
