...
phase: 22
spec: 5
slug: email-sms-provider-abuse
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/22-third-party-integrations/05-email-sms-provider-abuse.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 22.5 Email/SMS provider abuse

> Spec: [`22-third-party-integrations/05-email-sms-provider-abuse.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/22-third-party-integrations/05-email-sms-provider-abuse.md)
