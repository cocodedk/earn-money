...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/19-cryptography-and-secrets/01-hardcoded-secrets.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 19.1 Hardcoded secrets

> Spec: [`19-cryptography-and-secrets/01-hardcoded-secrets.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/19-cryptography-and-secrets/01-hardcoded-secrets.md)
