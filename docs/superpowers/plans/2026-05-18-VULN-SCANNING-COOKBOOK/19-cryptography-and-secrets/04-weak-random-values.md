...
phase: 19
spec: 4
slug: weak-random-values
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/19-cryptography-and-secrets/04-weak-random-values.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 19.4 Weak random values

> Spec: [`19-cryptography-and-secrets/04-weak-random-values.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/19-cryptography-and-secrets/04-weak-random-values.md)
