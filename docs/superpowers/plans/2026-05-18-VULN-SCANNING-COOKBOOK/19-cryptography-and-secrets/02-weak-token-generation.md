...
phase: 19
spec: 2
slug: weak-token-generation
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/19-cryptography-and-secrets/02-weak-token-generation.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 19.2 Weak token generation

> Spec: [`19-cryptography-and-secrets/02-weak-token-generation.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/19-cryptography-and-secrets/02-weak-token-generation.md)
