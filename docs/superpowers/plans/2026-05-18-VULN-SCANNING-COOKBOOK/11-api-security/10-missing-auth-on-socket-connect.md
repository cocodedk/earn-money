...
phase: 11
spec: 10
slug: missing-auth-on-socket-connect
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/10-missing-auth-on-socket-connect.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 11.10 Missing auth on socket connect

> Spec: [`11-api-security/10-missing-auth-on-socket-connect.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/10-missing-auth-on-socket-connect.md)
