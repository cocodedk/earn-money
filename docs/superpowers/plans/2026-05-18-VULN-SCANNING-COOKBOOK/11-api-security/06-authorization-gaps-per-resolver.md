...
phase: 11
spec: 6
slug: authorization-gaps-per-resolver
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/06-authorization-gaps-per-resolver.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 11.6 Authorization gaps per resolver

> Spec: [`11-api-security/06-authorization-gaps-per-resolver.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/06-authorization-gaps-per-resolver.md)
