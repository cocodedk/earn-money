...
phase: 11
spec: 17
slug: deprecated-endpoints-still-active
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/17-deprecated-endpoints-still-active.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 11.17 Deprecated endpoints still active

> Spec: [`11-api-security/17-deprecated-endpoints-still-active.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/17-deprecated-endpoints-still-active.md)
