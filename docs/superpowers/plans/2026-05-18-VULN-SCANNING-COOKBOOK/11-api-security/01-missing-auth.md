...
spec: 1
slug: missing-auth
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/01-missing-auth.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 11.1 Missing auth

> Spec: [`11-api-security/01-missing-auth.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/01-missing-auth.md)
