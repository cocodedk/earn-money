...
phase: 11
spec: 15
slug: weak-service-auth
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/15-weak-service-auth.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 11.15 Weak service auth

> Spec: [`11-api-security/15-weak-service-auth.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/15-weak-service-auth.md)
