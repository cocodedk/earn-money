...
phase: 11
spec: 11
slug: message-level-auth-bugs
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/11-message-level-auth-bugs.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 11.11 Message-level auth bugs

> Spec: [`11-api-security/11-message-level-auth-bugs.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/11-api-security/11-message-level-auth-bugs.md)
