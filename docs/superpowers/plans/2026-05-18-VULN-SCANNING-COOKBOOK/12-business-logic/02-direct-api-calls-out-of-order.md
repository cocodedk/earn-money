...
phase: 12
spec: 2
slug: direct-api-calls-out-of-order
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/12-business-logic/02-direct-api-calls-out-of-order.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 12.2 Direct API calls out of order

> Spec: [`12-business-logic/02-direct-api-calls-out-of-order.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/12-business-logic/02-direct-api-calls-out-of-order.md)
