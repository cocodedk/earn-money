...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/02-cloud-metadata-access.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 10.2 Cloud metadata access

> Spec: [`10-server-side-request-forgery/02-cloud-metadata-access.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/02-cloud-metadata-access.md)
