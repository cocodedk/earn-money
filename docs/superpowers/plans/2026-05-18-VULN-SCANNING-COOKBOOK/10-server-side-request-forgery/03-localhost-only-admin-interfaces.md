...
phase: 10
spec: 3
slug: localhost-only-admin-interfaces
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/03-localhost-only-admin-interfaces.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 10.3 Localhost-only admin interfaces

> Spec: [`10-server-side-request-forgery/03-localhost-only-admin-interfaces.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/03-localhost-only-admin-interfaces.md)
