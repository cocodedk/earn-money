...
phase: 10
spec: 6
slug: dns-rebinding-style-issues
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/06-dns-rebinding-style-issues.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 10.6 DNS rebinding-style issues

> Spec: [`10-server-side-request-forgery/06-dns-rebinding-style-issues.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/06-dns-rebinding-style-issues.md)
