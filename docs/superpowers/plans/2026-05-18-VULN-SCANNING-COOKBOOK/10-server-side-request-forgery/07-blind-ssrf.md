...
spec: 7
slug: blind-ssrf
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/07-blind-ssrf.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 10.7 Blind SSRF

> Spec: [`10-server-side-request-forgery/07-blind-ssrf.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/07-blind-ssrf.md)
