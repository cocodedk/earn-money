...
phase: 10
spec: 4
slug: url-parser-confusion
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/04-url-parser-confusion.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 10.4 URL parser confusion

> Spec: [`10-server-side-request-forgery/04-url-parser-confusion.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/04-url-parser-confusion.md)
