...
phase: 10
spec: 1
slug: internal-service-access
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/01-internal-service-access.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 10.1 Internal service access

> Spec: [`10-server-side-request-forgery/01-internal-service-access.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/01-internal-service-access.md)
