...
phase: 10
spec: 5
slug: redirect-based-ssrf
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/05-redirect-based-ssrf.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 10.5 Redirect-based SSRF

> Spec: [`10-server-side-request-forgery/05-redirect-based-ssrf.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/10-server-side-request-forgery/05-redirect-based-ssrf.md)
