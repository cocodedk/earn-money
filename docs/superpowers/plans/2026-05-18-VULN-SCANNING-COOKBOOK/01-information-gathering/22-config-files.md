...
spec: 22
slug: config-files
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/01-information-gathering/22-config-files.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 1.22 Config files

> Spec: [`01-information-gathering/22-config-files.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/01-information-gathering/22-config-files.md)
