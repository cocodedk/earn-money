...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/01-information-gathering/25-exported-database-files.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 1.25 Exported database files

> Spec: [`01-information-gathering/25-exported-database-files.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/01-information-gathering/25-exported-database-files.md)
