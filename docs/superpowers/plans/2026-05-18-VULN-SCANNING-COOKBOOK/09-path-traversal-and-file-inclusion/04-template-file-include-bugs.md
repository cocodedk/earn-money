...
phase: 9
spec: 4
slug: template-file-include-bugs
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/09-path-traversal-and-file-inclusion/04-template-file-include-bugs.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 9.4 Template/file include bugs

> Spec: [`09-path-traversal-and-file-inclusion/04-template-file-include-bugs.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/09-path-traversal-and-file-inclusion/04-template-file-include-bugs.md)
