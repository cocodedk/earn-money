...
phase: 9
spec: 3
slug: unsafe-download-endpoints
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/09-path-traversal-and-file-inclusion/03-unsafe-download-endpoints.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 9.3 Unsafe download endpoints

> Spec: [`09-path-traversal-and-file-inclusion/03-unsafe-download-endpoints.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/09-path-traversal-and-file-inclusion/03-unsafe-download-endpoints.md)
