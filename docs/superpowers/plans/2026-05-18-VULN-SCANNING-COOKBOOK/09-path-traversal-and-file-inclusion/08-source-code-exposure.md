...
phase: 9
spec: 8
slug: source-code-exposure
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/09-path-traversal-and-file-inclusion/08-source-code-exposure.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 9.8 Source code exposure

> Spec: [`09-path-traversal-and-file-inclusion/08-source-code-exposure.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/09-path-traversal-and-file-inclusion/08-source-code-exposure.md)
