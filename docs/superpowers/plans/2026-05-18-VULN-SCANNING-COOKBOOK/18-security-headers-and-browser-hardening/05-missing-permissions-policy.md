...
spec_file: docs/superpowers/specs/2026-05-18-VULN-SCANNING-COOK-BOOK/18-security-headers-and-browser-hardening/05-missing-permissions-policy.md
status: pending           # pending | drafted | approved | implemented | verified
implementation_file: null
test_file: null
---

# Plan: 18.5 Missing Permissions-Policy

> Spec: [`18-security-headers-and-browser-hardening/05-missing-permissions-policy.md`](../../specs/2026-05-18-VULN-SCANNING-COOK-BOOK/18-security-headers-and-browser-hardening/05-missing-permissions-policy.md)
