...
Covers lines 128-135: _load_mailbox_or_refuse when load_mailbox_backend
raises MailboxConfigError → emits AUTH_PROBE_REFUSED with
...
def test_mailbox_config_error_emits_missing_secret() -> None:
    ...
    env vars), the runner records MISSING_SECRET and returns — exercising
    lines 128-135 of runner.py."""
