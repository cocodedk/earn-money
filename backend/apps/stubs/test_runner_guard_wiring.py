...
_STUB_MODULES = (
    ...
    "apps.stubs.missing_lockout",
    "apps.stubs.weak_rate_limiting",
    "apps.stubs.predictable_reset_token",
    "apps.stubs.reset_token_reuse",
    "apps.stubs.weak_reset_expiry",
    "apps.stubs.reset_poisoning",
    "apps.stubs.email_change_takeover",
    "apps.stubs.mfa_bypass",
    "apps.stubs.mfa_missing_sensitive_flow",
    "apps.stubs.weak_recovery_codes",
    "apps.stubs.mfa_reset_abuse",
    "apps.stubs.oauth_redirect_uri",
    "apps.stubs.oauth_missing_state",
    "apps.stubs.oauth_token_substitution",
    "apps.stubs.oauth_account_linking",
    "apps.stubs.login_csrf",
    "apps.stubs.duplicate_account_confusion",
    "apps.stubs.email_verification_bypass",
    "apps.stubs.invitation_abuse",
    "apps.stubs.tenant_org_join_abuse",
)
