...
class StubsConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        from . import missing_lockout  # noqa: F401  registers "2.3"
        from . import weak_rate_limiting  # noqa: F401  registers "2.4"
        from . import predictable_reset_token  # noqa: F401  registers "2.5"
        from . import reset_token_reuse  # noqa: F401  registers "2.6"
        from . import weak_reset_expiry  # noqa: F401  registers "2.7"
        from . import reset_poisoning  # noqa: F401  registers "2.8"
        from . import email_change_takeover  # noqa: F401  registers "2.9"
        from . import mfa_bypass  # noqa: F401  registers "2.10"
        from . import mfa_missing_sensitive_flow  # noqa: F401  registers "2.11"
        from . import weak_recovery_codes  # noqa: F401  registers "2.12"
        from . import mfa_reset_abuse  # noqa: F401  registers "2.13"
        from . import oauth_redirect_uri  # noqa: F401  registers "2.14"
        from . import oauth_missing_state  # noqa: F401  registers "2.15"
        from . import oauth_token_substitution  # noqa: F401  registers "2.16"
        from . import oauth_account_linking  # noqa: F401  registers "2.17"
        from . import login_csrf  # noqa: F401  registers "2.18"
        from . import duplicate_account_confusion  # noqa: F401  registers "2.19"
        from . import email_verification_bypass  # noqa: F401  registers "2.20"
        from . import invitation_abuse  # noqa: F401  registers "2.21"
        from . import tenant_org_join_abuse  # noqa: F401  registers "2.22"
